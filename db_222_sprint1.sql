...
-- create tasksV1 table
/*CREATE TABLE IF NOT EXISTS tasksV1 (
...
/*INSERT INTO tasksV1 (title, description, assignees, status, createdOn, updatedOn)
...
-- select  tasksV1
/* SELECT * FROM tasksV1 order by createdOn asc; */
...
FROM tasks t join statuses s on t.statusId = s.statusId;
