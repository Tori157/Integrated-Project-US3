  ...
  <div class="p-10 w-screen h-screen bg-gray-800">
    <div class="itbkk-us3 container mx-auto w-full max-w-screen-xl">
      <div class="flex justify-between items-center mb-4">
        <h1 class="mb-4 text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-emerald-400 from-sky-400">
      ...
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="md:w-full table-auto text-sm text-left rtl:text-right border-blue-300">
          ...
          <tbody>
            <tr class="itbkk-item bg-blue-100 border-blue-300 hover:bg-blue-200" v-for="(task, index) in tasks" :key="index">
              <!-- id -->
              ...
              <td class="itbkk-title text-left">
                <a href="#" class=" px-6 py-4 font-medium text-base text-blue-600 hover:underline">{{ task.title.trim() }}</a>
              </td>

              <td class="itbkk-assignees px-6 py-4 text-center text-base text-blue-600 font-medium"
              ...
              <td class="itbkk-status">
                <div class="border-4 border-blue-100 rounded-3xl p-8 px-4 py-2 text-base text-white font-semibold text-center"
                  :class="{
        ...
        <div v-if="!tasks.length">
          <p class="text-center text-gray-500 text-base font-medium bg-white h-10 items-center flex justify-center">
            no tasks
          </p>
        </div>
